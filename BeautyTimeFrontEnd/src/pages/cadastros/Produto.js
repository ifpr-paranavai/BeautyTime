...
const Produto = () => {
    let objetoNovo = {
        nome: '', marca: '', precoCompra: 0.00, precoVenda: 0.00, status: true,
    };
    ...
    const precoCompraBodyTemplate = (rowData) => {
        return (<>
                <span className="p-column-title">Preço Compra</span>
                R$ {rowData.precoCompra}
            </>);
    }
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={objetos}
                        ...
                        <Column field="precoCompra" header="Preço Compra" sortable body={precoCompraBodyTemplate} headerStyle={{width: '14%', minWidth: '10rem'}}></Column>
                        <Column field="precoVenda" header="Preço Venda" sortable body={precoVendaBodyTemplate} headerStyle={{width: '14%', minWidth: '10rem'}}></Column>
                        <Column body={rowData => {
                    ...
                    <Dialog visible={objetoDialog} style={{width: '450px'}} header="Cadastrar/Editar" modal className="p-fluid" footer={objetoDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <InputText id="marca" value={objeto.marca} onChange={(e) => onInputChange(e, 'marca')} required autoFocus className={classNames({'p-invalid': submitted && !objeto.marca})}/>
                            {submitted && !objeto.name && <small className="p-invalid">Marca é Obrigatório.</small>}
                        </div>
                        <div className="field">
                            <label htmlFor="precoCompra">Preço Compra</label>
                            <InputText id="precoCompra" value={objeto.precoCompra} onChange={(e) => onInputChange(e, 'precoCompra')} required autoFocus className={classNames({'p-invalid': submitted && !objeto.precoCompra})}/>
                            {submitted && !objeto.name && <small className="p-invalid">Preço de venda é Obrigatório.</small>}
                        </div>
                        <div className="field">
                            <label htmlFor="precoVenda">Preço Venda</label>
                            <InputText id="precoVenda" value={objeto.precoVenda} onChange={(e) => onInputChange(e, 'precoVenda')} required autoFocus className={classNames({'p-invalid': submitted && !objeto.precoVenda})}/>
                            {submitted && !objeto.name && <small className="p-invalid">Preço de venda é Obrigatório.</small>}
                        </div>
                        <div className="field">
